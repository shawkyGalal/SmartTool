...
public class TableMaintDetailsSecurityControlHandlerImpl implements PersistentObjectSecurityControl
{
 ...
 return true;
	...
	public boolean isDisabled( Attribute pm_att) {
		...
		if(key.equalsIgnoreCase(TableMaintDetails.TABLE_NAME) || 
				key.equalsIgnoreCase(TableMaintDetails.COLUMN_NAME))
			return true;
		return false;
	}	
