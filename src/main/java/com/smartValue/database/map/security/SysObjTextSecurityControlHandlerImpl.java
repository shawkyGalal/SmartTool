...
public class SysObjTextSecurityControlHandlerImpl implements PersistentObjectSecurityControl
{
 ...
 return true;
	...
	public boolean isDisabled( Attribute pm_att) {
		...
		/*if(pmKey.equalsIgnoreCase(SysObjText.FRM_NAME ) ||
				pmKey.equalsIgnoreCase(SysObjText.FRM_OBJ_NAME))
			return true;
			*/
		return false;
}
