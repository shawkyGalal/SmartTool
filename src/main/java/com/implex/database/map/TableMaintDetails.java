...
import com.implex.HtmlTypes.IHtmlType;
import com.implex.HtmlTypes.InputText;
import com.implex.HtmlTypes.OutputLabel;
import com.implex.components.model.tree.PersistantTreeObject;
...
import com.implex.database.Facet;
import com.implex.database.MessagesCommnuicatorService;
import com.implex.database.Operation;
import com.implex.database.ParentPersistantObject;
import com.implex.database.PersistantObject;
import com.implex.database.attriburteProtectionType.AttBooleanSimpleImpl;
import com.implex.database.attriburteProtectionType.AttBooleanUsingUserDefVar;
import com.implex.database.attriburteProtectionType.AttBooleanUsingUsersAndGroups;
import com.implex.database.attriburteProtectionType.AttributePropertyController;
import com.implex.database.map.auto._TableMaintDetails;
import com.implex.database.map.security.PersistentObjectSecurityControl;
import com.implex.database.map.security.TableMaintDetailsSecurityControlHandlerImpl;
...
import com.implex.database.map.validators.TableMaintDetailsChangeValidator;
...
import com.implex.sys.map.AllConsColumns;
import com.implex.sys.map.AllConstraints;
...
//			this.getUsrDefVarValue(userDefUniqueName);
	...
	public Condition getCondition() {
	 ...
	 {
		return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.FileUploader ; 
	 }
	 
	 public boolean isOutputLabel()
	 {
		return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.OutputLabel ; 
	 }
	 
	 public boolean isInputText()
	 {
		return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.InputText ; 
	 }
	 
	 public boolean isInputTextArea()
	 {
		 return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.InputTextArea ; 
	 }
	 
	 public boolean isCalender()
	 {
		 return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.Calender ; 
	 }
	 public boolean isCharcterEditor()
	 {
		 return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.CharacterEditor ; 
	 }
	 public boolean isComboBox()
	 {
		 return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.ComboBox ; 
	 
	 }
	 public boolean isRichComboBox()
	 {
		 return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.RichComboBox ; 
	  
	 }
	 public boolean isRadioButton()
	 {
		 return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.RadioButtonGroup ; 
	 }
	 public boolean isPickList()
	 {
		 return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.PickList ; 
	 }
	 ...
	 public boolean isInputNumberSlider(){
		 return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.InputNumberSlider ; 
	 }
	 public boolean isInputTree(){
		 return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.SelectionTree ; 
	 }
...
//	}
	...
	private PersistantObject  geDataSetCurrentItem() 
	{
	 ...
	 {
		 return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.CheckBox ; 
	 }
	 public boolean isRichInputText()
	 {
		 return   this.getHtmlTypeImpl() instanceof com.implex.HtmlTypes.RichInputText ; 
	 }
