...
public class BankCutOffRq extends SADADMessage
{ 
  ...
  public BankCutOffRq(String xmlString ,boolean  validateSchema , Connection con) throws Exception
  {
    super(xmlString , validateSchema , con);
    setParameters();
  }
  public BankCutOffRq(String XmlFilePath , Connection con,boolean  validateSchema) throws Exception
  {
    super(XmlFilePath, con, validateSchema);
    setParameters();
  }
  
  public BankCutOffRq(URL XmlFileURL , Connection con,boolean validateSchema) throws Exception
  {
    super(XmlFileURL ,  con, validateSchema);
    setParameters();
  }
  
  public BankCutOffRq(Node pmtNotifyUploadRqNode , Connection con) throws Exception
  {
