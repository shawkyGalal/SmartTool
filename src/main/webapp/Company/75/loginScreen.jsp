  ...
  <body class="coming-soon rtl">
   <% 
	...
	{ 
	 ...
	 loginPageCookie.setValue("Company/75/loginScreen.jsp") ;
	...
	<div class="row">
		<div class="col-md-4 col-md-offset-4">
            ...
            <div class="text-center titlehomecom">
                <a href="#" class="logostock"><img src="<%=appURL%>/Company/75/images/mw-logo.png" width="200" height="80"></a>
                <span>Apigee Api Management System </span>
            </div>
