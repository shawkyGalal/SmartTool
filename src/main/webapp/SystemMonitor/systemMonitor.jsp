...
<%@page import="com.smartValue.database.*,com.smartValue.database.map.*"%>
...
<%
 ...
 try {
 for (com.smartValue.database.DbTable xx : listOfUsedTables.keySet())
 {
 ...
 %> Unable To render PO:  <%=po1 %>  Due To <%= e %> <% }
