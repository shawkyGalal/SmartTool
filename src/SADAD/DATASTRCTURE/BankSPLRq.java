...
public class BankSPLRq extends SADADMessage
{ 
  ...
  public BankSPLRq(String xmlString ,boolean  validateSchema , Connection con) throws Exception
  {
    super(xmlString , validateSchema , con);
    setParameters();
  }
  public BankSPLRq(String XmlFilePath , Connection con,boolean  validateSchema) throws Exception
  {
    super(XmlFilePath, con, validateSchema);
    setParameters();
  }
  
  public BankSPLRq(URL XmlFileURL , Connection con,boolean validateSchema) throws Exception
  {
    super(XmlFileURL ,  con, validateSchema);
    setParameters();
  }
  
  public BankSPLRq(Node pmtNotifyUploadRqNode , Connection con) throws Exception
  {
