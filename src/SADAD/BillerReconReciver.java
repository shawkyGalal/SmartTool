 ...
 */
public class BillerReconReciver extends HttpServlet 
{
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException
  {
    ...
    BillerReconUploadRq bcrq = (BillerReconUploadRq)serviceRq.billerSvcRq.messageRequests.elementAt(0);
    ...
    serviceRsStr +="      <MsgCode>BLRCRS</MsgCode>";
    serviceRsStr +="    </SignonProfile>";
    serviceRsStr +="  </SignonRs>";
    ...
    serviceRsStr +="    <BillerReconUploadRs>";
