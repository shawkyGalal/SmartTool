...
public class HttpPoster 
{
  ...
  public HttpPoster(String urlString , String m_proxyServer , String m_userName , String m_password) throws Exception
  {
    ...
    this(new URL(urlString), m_proxyServer, m_userName ,  m_password );
  }
  public HttpPoster(URL url , String m_proxyServer , String m_userName , String m_password) throws Exception
  {
...
try {
 ...
 {
   this.con.setRequestProperty("Content-type" ,content_type );
 }
