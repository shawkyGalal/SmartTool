...
public class URLDownLoadFrame_AboutBoxPanel1 extends JPanel 
{
  ...
  public URLDownLoadFrame_AboutBoxPanel1()
  {
    try
    {
      jbInit();
  ...
  private void jbInit() throws Exception
  {
    ...
    labelTitle.setText("Title : URL Down Load Application");
    labelAuthor.setText("Author : Shawky Galal Foda");
    labelCopyright.setText("Copyright");
    labelCompany.setText("Company : NCCI");
