...
public class ConnectionFactory 
{
  ...
  public static void main(String[] args)
  {
    ...
    String url = "jdbc:oracle:thin:@localhost:1521:xe";//"jdbc:jtds:sqlserver://localhost:1433;databasename=scdb ";
    String driver = "oracle.jdbc.driver.OracleDriver";//"net.sourceforge.jtds.jdbc.Driver";
    Connection con =  ConnectionFactory.createConnectionByUrl(url,driver,"support","123");
