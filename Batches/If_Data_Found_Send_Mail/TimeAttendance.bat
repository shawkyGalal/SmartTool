...
set _APP= Support.SqlReader ifDataFoundSendQueryResultByMail 20554 0 "Time Attendance (ODBC)" attread 123 $$empID 74

@echo on

java.exe -classpath %_CP% %_OPT% %_APP% >>TimeAttendannce.log
