...
set _CP=%_CP%..\WebContent\WEB-INF\lib\my_side-sas.jar;
...
set _APP=Support.DownLoad.URLContentMailSender sfoda@eastnets.com foda.sh@gmail.com Emp_LIST http://127.0.0.1:9090/SmartTool/executeQuery.jsp id=16490 AutoLog=Y
@echo on

java.exe -classpath %_CP% %_OPT% %_APP%
