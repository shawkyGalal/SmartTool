...
<%@page import="com.implex.database.map.SysParams"%><html>



<head>
<link rel="shortcut icon" href="/SmartTool/Company/20/images/logo.png">
...
<link href="<%=appURL%>/jQueryAssets/jquery.ui.theme.min.css" rel="stylesheet" type="text/css">
	...
	<title>مجموعة شركات الجهاز  </title>
...
<% 
   ...
   Google Chrome is the Recommended Browser for this System ...<a href= "https://www.google.com/chrome/browser/desktop/" target = "Google Chrome DownLoad" > DownLoad Google Chrome</a>
    ...
    <br><div align="center"> 
  	...
  	<br><font size="6">   مجموعة شركات الجهاز     <p>   Al Gihaz Group   </p>  </font> 
  	<p><font size="5" ><Strong>Enterprise Performance Management System (EPM)</strong></font>
  </p>
  <p> <font size="2"> بالمملكة العربية السعودية </font> </p>
  <table>
  	<tr>
  		<td><div align="center"><big>
  		<img src="<%=appURL%>/Company/20/images/logo.png" style="height: 96px; width: 300px"></big><font size="2"><big>&nbsp;</big></font></div> </td>
		
		<td><div align="center"><font size="2"><a href="http://www.smart-value.com"><big></big></a></font></div></td>
	</tr>
	</table>
</div>
...
//-----------Closing and Removing the Reposatory Connection---------
   ...
   if (request.getParameter("login")!= null)
  {
      ...
      String loggedUser = Misc.getConnectionUserName(con).toUpperCase();  // Upper Case used to MS SQL Server
        ...
        try {// Create a "My Favofrite Node Under  Private Node "
      	  String favoriteNodeInsStmt = "Insert into support.lu_Queries (code , e_dsc , a_dsc , parent_id  , query_body ) " ; 
  ...
  //------------if Login passed then create the tree object in the session -----------
	...
	//secUsrDtaServices.setUseRepoConnection (true) ; 
    ...
    try{
      ...
      */
      ...
      String message = userName.toUpperCase() + " Have logged now to "+selectedConnParms.name+" using Support Tool Running on :\n"+appURL+"\n from machine  "  +remoteAddr  + " From Mac Address: " + remoteMac;
