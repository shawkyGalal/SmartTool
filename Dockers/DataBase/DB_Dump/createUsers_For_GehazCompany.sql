...
CREATE TABLESPACE PNU_DATA DATAFILE 
  'D:\Oracle\oradata\svdb\PNU\PNU_DATA' SIZE 2048M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
LOGGING
ONLINE
PERMANENT
...
CREATE TEMPORARY TABLESPACE PNU_TMP TEMPFILE 
  'D:\Oracle\oradata\svdb\PNU\PNU_TMP' SIZE 500M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
TABLESPACE GROUP ''
...
CREATE TABLESPACE CAROLD_DATA DATAFILE 
  'D:\Oracle\oradata\svdb\CAROLD\CAROLD_DATA' SIZE 512M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
LOGGING
ONLINE
PERMANENT
EXTENT MANAGEMENT LOCAL AUTOALLOCATE
...
CREATE TEMPORARY TABLESPACE CAROLD_TMP TEMPFILE 
  'D:\Oracle\oradata\svdb\CAROLD\CAROLD_TMP' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
TABLESPACE GROUP ''
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;
...
CREATE TABLESPACE CARRENT_DATA DATAFILE 
  'D:\Oracle\oradata\svdb\CARRENT\CARRENT_DATA' SIZE 512M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
LOGGING
ONLINE
PERMANENT
EXTENT MANAGEMENT LOCAL AUTOALLOCATE
...
CREATE TEMPORARY TABLESPACE CARRENT_TMP TEMPFILE 
  'D:\Oracle\oradata\svdb\CARRENT\CARRENT_TMP' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
TABLESPACE GROUP ''
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;
...
CREATE TABLESPACE ICDB_DATA DATAFILE 
  'D:\Oracle\oradata\svdb\ICDB\ICDB_DATA' SIZE 512M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
LOGGING
ONLINE
PERMANENT
EXTENT MANAGEMENT LOCAL AUTOALLOCATE
...
CREATE TEMPORARY TABLESPACE ICDB_TMP TEMPFILE 
  'D:\Oracle\oradata\svdb\ICDB\ICDB_TMP' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
TABLESPACE GROUP ''
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;
...
CREATE TABLESPACE SUPPORT_DATA DATAFILE 
  'D:\Oracle\oradata\svdb\SUPPORT\SUPPORT_DATA' SIZE 512M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
LOGGING
ONLINE
PERMANENT
EXTENT MANAGEMENT LOCAL AUTOALLOCATE
...
CREATE TEMPORARY TABLESPACE SUPPORT_TMP TEMPFILE 
  'D:\Oracle\oradata\svdb\SUPPORT\SUPPORT_TMP' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
TABLESPACE GROUP ''
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;
...
CREATE TABLESPACE JCCS_DATA DATAFILE 
  'D:\Oracle\oradata\svdb\JCCS\JCCS_DATA' SIZE 512M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
LOGGING
ONLINE
PERMANENT
EXTENT MANAGEMENT LOCAL AUTOALLOCATE
...
CREATE TEMPORARY TABLESPACE JCCS_TMP TEMPFILE 
  'D:\Oracle\oradata\svdb\JCCS\JCCS_TMP' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
TABLESPACE GROUP ''
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;
...
CREATE TABLESPACE MOEP_DATA DATAFILE 
  'D:\Oracle\oradata\svdb\MOEP\MOEP_DATA' SIZE 512M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
LOGGING
ONLINE
PERMANENT
EXTENT MANAGEMENT LOCAL AUTOALLOCATE
...
CREATE TEMPORARY TABLESPACE MOEP_TMP TEMPFILE 
  'D:\Oracle\oradata\svdb\MOEP\MOEP_TMP' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
TABLESPACE GROUP ''
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;
