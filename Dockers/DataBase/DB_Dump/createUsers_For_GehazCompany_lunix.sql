...
CREATE TABLESPACE PNU_DATA DATAFILE 
  '/u01/app/oracle/oradata/orcl/PNU/PNU_DATA' SIZE 512M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
...
CREATE TEMPORARY TABLESPACE PNU_TMP TEMPFILE 
  '/u01/app/oracle/oradata/orcl/PNU/PNU_TMP' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED 
  TABLESPACE GROUP ''
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;

CREATE TABLESPACE CARRENT_DATA DATAFILE 
  '/u01/app/oracle/oradata/orcl/CARRENT/CARRENT_DATA' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
...
CREATE TEMPORARY TABLESPACE CARRENT_TMP TEMPFILE 
  '/u01/app/oracle/oradata/orcl/CARRENT/CARRENT_TMP' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
TABLESPACE GROUP ''
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;

CREATE TABLESPACE ICDB_DATA DATAFILE 
  '/u01/app/oracle/oradata/orcl/ICDB/ICDB_DATA' SIZE 512M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
LOGGING ONLINE PERMANENT EXTENT MANAGEMENT LOCAL AUTOALLOCATE BLOCKSIZE 8K SEGMENT SPACE MANAGEMENT AUTO
FLASHBACK ON;
CREATE TEMPORARY TABLESPACE ICDB_TMP TEMPFILE 
  '/u01/app/oracle/oradata/orcl/ICDB/ICDB_TMP' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
TABLESPACE GROUP ''
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;

CREATE TABLESPACE SUPPORT_DATA DATAFILE 
  '/u01/app/oracle/oradata/orcl/SUPPORT/SUPPORT_DATA' SIZE 512M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
LOGGING ONLINE PERMANENT EXTENT MANAGEMENT LOCAL AUTOALLOCATE BLOCKSIZE 8K SEGMENT SPACE MANAGEMENT AUTO
FLASHBACK ON;
CREATE TEMPORARY TABLESPACE SUPPORT_TMP TEMPFILE 
  '/u01/app/oracle/oradata/orcl/SUPPORT/SUPPORT_TMP' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
TABLESPACE GROUP ''
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;

CREATE TABLESPACE JCCS_DATA DATAFILE 
  '/u01/app/oracle/oradata/orcl/JCCS/JCCS_DATA' SIZE 512M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
LOGGING ONLINE PERMANENT EXTENT MANAGEMENT LOCAL AUTOALLOCATE BLOCKSIZE 8K SEGMENT SPACE MANAGEMENT AUTO
FLASHBACK ON;
CREATE TEMPORARY TABLESPACE JCCS_TMP TEMPFILE 
  '/u01/app/oracle/oradata/orcl/JCCS/JCCS_TMP' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
TABLESPACE GROUP ''
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;

CREATE TABLESPACE MOEP_DATA DATAFILE 
  '/u01/app/oracle/oradata/orcl/MOEP/MOEP_DATA' SIZE 512M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
LOGGING ONLINE PERMANENT EXTENT MANAGEMENT LOCAL AUTOALLOCATE BLOCKSIZE 8K SEGMENT SPACE MANAGEMENT AUTO
FLASHBACK ON;
CREATE TEMPORARY TABLESPACE MOEP_TMP TEMPFILE 
  '/u01/app/oracle/oradata/orcl/MOEP/MOEP_TMP' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
TABLESPACE GROUP ''
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;

CREATE TABLESPACE GIHAZ_DATA DATAFILE 
  '/u01/app/oracle/oradata/orcl/GIHAZ/GIHAZ_DATA' SIZE 512M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
LOGGING ONLINE PERMANENT EXTENT MANAGEMENT LOCAL AUTOALLOCATE BLOCKSIZE 8K SEGMENT SPACE MANAGEMENT AUTO
FLASHBACK ON;
CREATE TEMPORARY TABLESPACE GIHAZ_TMP TEMPFILE 
  '/u01/app/oracle/oradata/orcl/GIHAZ/GIHAZ_TMP' SIZE 256M AUTOEXTEND ON NEXT 50M MAXSIZE UNLIMITED
TABLESPACE GROUP ''
EXTENT MANAGEMENT LOCAL UNIFORM SIZE 1M;
