create or replace package comp.import_policy as
       procedure import_policy_from_prod(v_policy_No number );

end;
/
create or replace package body comp.import_policy as
...
*/                                          
                        ( select * from comp.rukhsa_pros_rnwl@edget.world rukh where rukh.plcy_policy_no= v_policy_No );
